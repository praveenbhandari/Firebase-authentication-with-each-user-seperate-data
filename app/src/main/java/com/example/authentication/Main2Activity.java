    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!name1.equals("") && !addr1.equals("")) {
                    ...
                    String uid = user1.getUid(); //unique user id is created for each user

                    //create new object in firebase firestore

                    Map<String, Object> user = new HashMap<>();
                    user.put("name", name1);
                    user.put("address", addr1);

                    //creating new collection with userid which is unique for each new user
        ...
        retrive.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //reference for the document where the data is stored
